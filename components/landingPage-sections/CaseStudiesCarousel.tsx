...
const caseStudies: CaseStudy[] = [
  {
    ...
    title: "People love the idea of a platform that combines community, learning, and real-time discussions.",
    features: ["Discussions", "Forums", "Course Pages"],
    quote: "If this launches, it will solve a real problem. Learning feels lonely — a community-driven platform is exactly what we need.",
    attribution: "Beta Test Group",
    accentColor: "#16b364",
    cards: [
      { type: "notion", delay: 0, zIndex: 1 },
      { type: "slack", delay: 0.1, zIndex: 2 }
    ],
  },

  {
    id: "creators",
    company: "Creators & Trainers",
    logo: (
    ...
    title: "Creators believe the platform could simplify course delivery and student engagement.",
    features: ["Creator Tools", "Course Analytics", "Community"],
    quote: "As an instructor, I’ve never had a place where courses, community, and discussions live together. This is refreshing.",
    attribution: "Independent Instructors Group",
    accentColor: "#3b82f6",
    cards: [
      { type: "stripe", delay: 0, zIndex: 1 },
      { type: "slack", delay: 0.1, zIndex: 2 }
    ],
  },

  {
    ...
    title: "Learners think the idea promotes accountability and makes progress more fun.",
    features: ["Community Learning", "Peer Support"],
    quote: "Studying with people who have the same goals boosts motivation. This platform gives that sense of belonging.",
    attribution: "Student Feedback Panel",
    accentColor: "#0A0D12",
    cards: [
      { type: "meeting", delay: 0, zIndex: 1 },
      { type: "slack", delay: 0.1, zIndex: 2 }
    ],
  },

  {
    ...
    title: "Tech enthusiasts like the transparency, open feedback features, and real-time discussions.",
    features: ["Live Chat", "Realtime Discussions", "Open Feedback"],
    quote: "The fact that ideas can be shared, rated, and discussed publicly before launch is genius.",
    attribution: "Product & Engineering Community",
    accentColor: "#155eef",
    cards: [
      { type: "figma", delay: 0, zIndex: 1 },
      { type: "meeting", delay: 0.1, zIndex: 2 }
    ],
  },
]
