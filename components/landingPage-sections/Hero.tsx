      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
                Our platform brings together expert-led courses, in-lesson discussions, and a vibrant learning community — 
  all in one place. Learn, connect, and grow with people who share your goals.
            </p>
